...
public class DrawingUtils
{
    ...
    public static void DrawCenterOfTrajectory(Graphics g, MusicSignatureBuilder.Point point, int side, float length)
    {
        ...
        g.FillEllipse(Brushes.Blue, translated.X - markerSize, translated.Y - markerSize, markerSize * 2, markerSize * 2);
        g.FillEllipse(Brushes.DarkOrange, translated.X - markerSize / 2, translated.Y - markerSize / 2, markerSize, markerSize);
    }
